...
const PropertyCard = ({ property }) => {
  return (
    <div className="relative mx-auto w-[25vw]">
      <Link to={`/property/:${property?.id}`} className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
        <div className="shadow p-4 rounded-lg bg-white">
          <div className={`bg-cover bg-[url(${property?.image})] flex justify-center relative rounded-lg overflow-hidden h-52`}>
            ...
            <div className="absolute flex justify-center bottom-0 mb-3">
              <div className="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                <p className="flex items-center font-medium text-[#000]">
                  For Rent
                </p>
              </div>
            </div>
